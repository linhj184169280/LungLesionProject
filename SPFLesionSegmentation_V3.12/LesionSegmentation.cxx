...
//	ofstream tcout( "e:/record.txt" );
  ...
  typedef MySpace::SPFLesionSegmentationFilter< InputImageType, RealImageType > SegmentationFilterType;
  ...
  std::cout << "ROI region is " << roiRegion <<  " : covers voxels = "
   ...
   << " mm^3" << std::endl;
/////////////////////////////////////////////////////////////////////
    tcout << "ROI region is " << roiRegion <<  " : covers voxels = "
    << roiRegion.GetNumberOfPixels() << " : " <<
    image->GetSpacing()[0]*image->GetSpacing()[1]*image->GetSpacing()[2]*roiRegion.GetNumberOfPixels()
   << " mm^3" << std::endl;
...
//  seg->AddObserver( itk::ProgressEvent(), progressCommand );
  ...
  tcout<<"Time = "<<duration/1000<<"sec, = "<<duration<<"ms"<<endl;
...
////////////////////////////////////////////////////////////////////////
    tcout << "Volume of segmentation mm^3 = " << volume << std::endl;
////////////////////////////////////////////////////////////////////////
  if( args.GetOptionWasSet("OutputMesh"))
    {
    VTK_CREATE(vtkSTLWriter, writer);
	string meshpath = OutputDirPath+"/"+args.GetValueAsString("OutputMesh");

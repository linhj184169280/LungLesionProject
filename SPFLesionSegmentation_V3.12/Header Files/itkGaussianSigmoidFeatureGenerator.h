/*=========================================================================
  ...
  Module:    itkGaussianSigmoidFeatureGenerator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkGaussianSigmoidFeatureGenerator_h
#define __itkGaussianSigmoidFeatureGenerator_h
...
/** \class GaussianSigmoidFeatureGenerator
...
class ITK_EXPORT GaussianSigmoidFeatureGenerator : public FeatureGenerator<NDimension>
{
public:
  /** Standard class typedefs. */
  typedef GaussianSigmoidFeatureGenerator          Self;
  ...
  itkTypeMacro(GaussianSigmoidFeatureGenerator, FeatureGenerator);
  ...
  itkGetMacro( GaussianSigma, double );

  /** Alpha value to be used in the Sigmoid filter. */
  itkSetMacro( GaussianNeiborSize, unsigned short );
  itkGetMacro( GaussianNeiborSize, unsigned short );

protected:
  GaussianSigmoidFeatureGenerator();
  virtual ~GaussianSigmoidFeatureGenerator();
...
private:
  GaussianSigmoidFeatureGenerator(const Self&); //purposely not implemented
  ...
  typedef itk::CastImageFilter< 
	  InputImageType, InternalImageType>			  CastToRealFilterType;
  typedef typename CastToRealFilterType::Pointer	  CastToRealFilterPointer;
  ...
  CastToRealFilterPointer		  m_CastToRealFilter;
  ...
  unsigned short				  m_GaussianNeiborSize;
};

} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
# include "itkGaussianSigmoidFeatureGenerator.hxx"
#endif

/*=========================================================================
  ...
  Module:    itkNoCastLungWallFeatureGenerator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkNoCastLungWallFeatureGenerator_h
#define __itkNoCastLungWallFeatureGenerator_h
...
/** \class NoCastLungWallFeatureGenerator
...
class ITK_EXPORT NoCastLungWallFeatureGenerator : public FeatureGenerator<NDimension>
{
public:
  /** Standard class typedefs. */
  typedef NoCastLungWallFeatureGenerator         Self;
  ...
  itkTypeMacro(NoCastLungWallFeatureGenerator, FeatureGenerator);
...
protected:
  ...
  virtual ~NoCastLungWallFeatureGenerator();
...
private:
  NoCastLungWallFeatureGenerator(const Self&); //purposely not implemented
...
# include "itkNoCastLungWallFeatureGenerator.hxx"
#endif

/*=========================================================================
  ...
  Module:    SPFLesionSegmentationFilter.hxx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __SPFLesionSegmentationFilter_hxx
#define __SPFLesionSegmentationFilter_hxx
...
SPFLesionSegmentationFilter<TInputImage, TOutputImage>::
...
/////////FeatureGernerator Begin/////////////
  m_WindowCastFeatureGernerator = WindowCastFeatureGeneratorType::New();
  m_GaussianSigmoidFeatureGenerator = GaussianSigmoidFeatureGeneratorType::New();
...
/////////FeatureGernerator Begin/////////////
  m_WindowCastFeatureGernerator->SetInput( m_InputSpatialObject );
  m_GaussianSigmoidFeatureGenerator->SetInput( m_InputSpatialObject );
/////////FeatureGernerator End/////////////
...
/////////FeatureGernerator Begin/////////////
//  m_FeatureAggregator->AddFeatureGenerator( m_WindowCastFeatureGernerator );
//  m_FeatureAggregator->AddFeatureGenerator( m_GaussianSigmoidFeatureGenerator );
/////////FeatureGernerator End/////////////
...
/////////FeatureGernerator Begin/////////////
  m_GaussianSigmoidFeatureGenerator->SetAlpha( 100.0 );
  m_GaussianSigmoidFeatureGenerator->SetBeta( -500.0 );
  m_GaussianSigmoidFeatureGenerator->SetGaussianSigma( 0.5 );
  m_GaussianSigmoidFeatureGenerator->SetGaussianNeiborSize( 5 );
/////////FeatureGernerator End/////////////


  m_FastMarchingStoppingTime = 5.0;				//StoppingTime
  m_FastMarchingDistanceFromSeeds = 0.5;		//DisDistanceFromSeeds
//  m_FastMarchingDistanceFromSeeds = 30.0;		//DisDistanceFromSeeds
  m_SigmoidBeta = -500.0;
  m_StatusMessage = "";
...
template <class TInputImage, class TOutputImage>
void SPFLesionSegmentationFilter< TInputImage,TOutputImage >

/*=========================================================================
  ...
  Module:    itkNoCastCannyEdgesFeatureGenerator.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkNoCastCannyEdgesFeatureGenerator_h
#define __itkNoCastCannyEdgesFeatureGenerator_h
...
/** \class NoCastCannyEdgesFeatureGenerator
...
class ITK_EXPORT NoCastCannyEdgesFeatureGenerator : public FeatureGenerator<NDimension>
{
public:
  /** Standard class typedefs. */
  typedef NoCastCannyEdgesFeatureGenerator                        Self;
  ...
  itkTypeMacro(NoCastCannyEdgesFeatureGenerator, FeatureGenerator);
...
protected:
  ...
  virtual ~NoCastCannyEdgesFeatureGenerator();
...
private:
  NoCastCannyEdgesFeatureGenerator(const Self&); //purposely not implemented
...
# include "itkNoCastCannyEdgesFeatureGenerator.hxx"
#endif
